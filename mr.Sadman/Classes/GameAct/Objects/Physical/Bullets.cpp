...
Bullets::initialize()
{
	...
	_particle->setTexture( Resources::Cache::getInstance().getObjectRepresentation( getName() )->getTexture() );
...
void
Bullets::setRotation( float angle )
{
	_angle = angle;

	Stream::setRotation( angle );
}
